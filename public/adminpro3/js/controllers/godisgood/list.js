app.controller('GisGCtrl', function ($scope,$rootScope,$uibModal,$timeout,$filter,Api,Cloud) {
$scope.spinner.on();
  function loadData(){
    Api.getGodisgoods().success(function (data) {
...
app.controller('AlbumInstanceCtrl', function ($scope,$rootScope,$uibModalInstance,$filter,Api,Cloud) {
  ...
  $scope.deleteConfirm = function() {
    ...
    Api.deleteGodisgoods($rootScope.AlbumDelete.id).success(function (){
