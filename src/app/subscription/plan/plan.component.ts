...
export class PlanComponent implements OnInit {
  ...
  constructor(
    ...
    this.load = false;
  	this.period = [
  	{ nombre:"SEMANAL", desc: "4 entregas de flores al mes (segun plan)*", icon:"assets/imgs/icons/icon-flores.png", number:4,class:'<div class="col-xs-1 col-sm-1 title hotel-middle clearfix cell-view" ><img class="period" src="assets/imgs/icons/icon-flores.png" alt=""></div><div class="col-xs-1 col-sm-1 title hotel-middle clearfix cell-view"><img class="period" src="assets/imgs/icons/icon-flores.png" alt=""></div><div class="col-xs-1 col-sm-1 title hotel-middle clearfix cell-view"><img class="period" src="assets/imgs/icons/icon-flores.png" alt=""></div><div class="col-xs-1 col-sm-1 title hotel-middle clearfix cell-view"><img class="period" src="assets/imgs/icons/icon-flores.png" alt="">'},
  	{ nombre:"QUINCENAL", desc: "2 entregas de flores al mes (segun plan)*", icon:"assets/imgs/icons/icon-flores.png", number:2,class:'<div class="col-xs-1 col-sm-1 title hotel-middle clearfix cell-view"></div><div class="col-xs-1 col-sm-1 title hotel-middle clearfix cell-view"><img class="period" src="assets/imgs/icons/icon-flores.png" alt=""></div><div class="col-xs-1 col-sm-1 title hotel-middle clearfix cell-view"><img class="period" src="assets/imgs/icons/icon-flores.png" alt=""></div><div class="col-xs-1 col-sm-1 title hotel-middle clearfix cell-view"></div>'},
  	{ nombre:"MENSUAL", desc: "1 entregas de flores al mes (segun plan)*", icon:"assets/imgs/icons/icon-flores.png", number:1, class:'<div class="col-xs-4 col-sm-4 title hotel-middle clearfix cell-view text-center"><img class="period" src="assets/imgs/icons/icon-flores.png" alt=""></div>'}
  	];
